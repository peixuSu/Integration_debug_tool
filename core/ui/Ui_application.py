...
class Ui_Application(object):
    def setupUi(self, Application):
        ...
        sizePolicy2.setHeightForWidth(self.label_io.sizePolicy().hasHeightForWidth())
        self.label_io.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.label_decive.sizePolicy().hasHeightForWidth())
        self.label_decive.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.label_speed.sizePolicy().hasHeightForWidth())
        self.label_speed.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.label_bit.sizePolicy().hasHeightForWidth())
        self.label_bit.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.label_clk.sizePolicy().hasHeightForWidth())
        self.label_clk.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.label_s_or_q.sizePolicy().hasHeightForWidth())
        self.label_s_or_q.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.label_vcc.sizePolicy().hasHeightForWidth())
        self.label_vcc.setSizePolicy(sizePolicy2)
        ...
        self.gridWidget_test_group.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.button_add_test_group.setMaximumSize(QSize(16777215, 25))
        ...
        sizePolicy3.setHeightForWidth(self.tree_group.sizePolicy().hasHeightForWidth())
        self.tree_group.setSizePolicy(sizePolicy3)
        ...
        self.button_del_test_group.setMaximumSize(QSize(16777215, 25))
        ...
        sizePolicy4.setHeightForWidth(self.line_prj_name.sizePolicy().hasHeightForWidth())
        self.line_prj_name.setSizePolicy(sizePolicy4)
        self.line_prj_name.setMinimumSize(QSize(0, 0))
        ...
        self.combo_box_data_group.setMinimumSize(QSize(0, 25))
        ...
        sizePolicy2.setHeightForWidth(self.label_receive_size.sizePolicy().hasHeightForWidth())
        self.label_receive_size.setSizePolicy(sizePolicy2)
        ...
        sizePolicy5.setHeightForWidth(self.list_data.sizePolicy().hasHeightForWidth())
        self.list_data.setSizePolicy(sizePolicy5)
        ...
        self.verticalSpacer = QSpacerItem(0, 140, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        sizePolicy6.setHeightForWidth(self.gridWidget_log.sizePolicy().hasHeightForWidth())
        self.gridWidget_log.setSizePolicy(sizePolicy6)
        self.gridWidget_log.setMinimumSize(QSize(0, 70))
        self.gridWidget_log.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.listWidget_log_normal.sizePolicy().hasHeightForWidth())
        self.listWidget_log_normal.setSizePolicy(sizePolicy3)
        ...
        sizePolicy7 = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Minimum)
        sizePolicy7.setHorizontalStretch(0)
        sizePolicy7.setVerticalStretch(0)
        sizePolicy7.setHeightForWidth(self.listWidget_log.sizePolicy().hasHeightForWidth())
        self.listWidget_log.setSizePolicy(sizePolicy7)
        self.listWidget_log.setMinimumSize(QSize(0, 90))
